(function($){
    ...
    var applicationsJSON = {
        "apps": [
            {"id": 0, "name": "Bastion", "image": "img/boxart/bastion.jpg", "location": "", "genre": "Action, Indie, RPG", "description": "Bastion is an action role-playing experience that redefines storytelling in games, with a reactive narrator who marks your every move. Explore more than 40 lush hand-painted environments as you discover the secrets of the Calamity, a surreal catastrophe that shattered the world to pieces."},
            {"id": 1, "name": "CaveStory+", "image": "img/boxart/cavestory+.jpg", "location": "", "genre": "", "description": ""},
            {"id": 2, "name": "Dead Island", "image": "img/boxart/deadisland.jpg", "location": "", "genre": "", "description": ""},
            {"id": 3, "name": "Diablo 3", "image": "img/boxart/diablo3.jpg", "location": "", "genre": "", "description": ""},
            {"id": 4, "name": "Dustforce", "image": "img/boxart/dustforce.jpg", "location": "", "genre": "", "description": ""},
            {"id": 5, "name": "From Dust", "image": "img/boxart/fromdust.jpg", "location": "", "genre": "", "description": ""},
            {"id": 6, "name": "Left 4 Dead 2", "image": "img/boxart/left4dead2.jpg", "location": "", "genre": "", "description" : ""},
            {"id": 7, "name": "Limbo", "image": "img/boxart/limbo.jpg", "location": "", "genre": "", "description": ""},
            {"id": 8, "name": "Rochard", "image": "img/boxart/rochard.jpg", "location": "", "genre": "", "description": ""},
            {"id": 9, "name": "Shank", "image": "img/boxart/shank.jpg", "location": "", "genre": "", "description": ""},
            {"id": 10, "name": "Shank 2", "image": "img/boxart/shank2.jpg", "location": "", "genre": "", "description": ""},
            {"id": 11, "name": "Skyrim", "image": "img/boxart/skyrim.jpg", "location": "", "genre": "", "description": ""},
            {"id": 12, "name": "Starcraft 2", "image": "img/boxart/starcraft2.jpg", "location": "", "genre": "", "description": ""},
            {"id": 13, "name": "Stealth Bastard", "image": "img/boxart/stealthbastard.jpg", "location": "", "genre": "", "description": ""},
            {"id": 14, "name": "Super Meat Boy", "image": "img/boxart/supermeatboy.jpg", "location": "", "genre": "", "description": ""},
            {"id": 15, "name": "Team Fortress 2", "image": "img/boxart/teamfortress2.jpg", "location": "", "genre": "", "description": ""},
            {"id": 16, "name": "Terraria", "image": "img/boxart/terraria.jpg", "location": "", "genre": "", "description": ""},
            {"id": 17, "name": "Trine", "image": "img/boxart/trine.jpg", "location": "", "genre": "", "description": ""},
            {"id": 18, "name": "Unreal Tournament 3", "image": "img/boxart/ut3.jpg", "location": "", "genre": "", "description": ""}
        ]
    };
...
//            }
    ...
    var menuEvents = function() {
            ...
            $('body').on('click', function(event) {
                if($(event.target).attr('id') != 'menu' && $(event.target).parent().attr('id') != 'menu') {
                    $('#menu').fadeOut('slow'); 
                }
            });
